...
Para sacarle provecho a Git es necesario conocer y trabajar con la terminal y la linea de trabajo. Acá recompilaré algunos comandos y buenas practicas, pero les recomiendo que la estudien por su cuenta, se darán cuenta que no cambiaran el CMD o la terminal por ningún interfaz gráfico.
